...
export default function SettingsPanel() {
  ...
  const [activeSection, setActiveSection] = useState<
    'cli-defaults' | 'dir-path' | 'bin-path'
  >('cli-defaults');
          ...
          <div className="space-y-5">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted">
                  Configure cli-defaults.yml — download behavior & filename
                  template
                </p>
              </div>
              <button
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                onChange={(e) =>
                  updateValue('cli-defaults', 'fileName', e.target.value)
                }
              ...
              <p className="text-xs text-muted flex items-center gap-1">
                ...
                Click a variable to append it. Use path separators to create
                folders.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                <input
                  ...
                  onChange={(e) =>
                    updateValue('cli-defaults', 'q', parseInt(e.target.value) || 0)
                  }
              ...
              <SettingField label="Server" description="Server number to use">
                <select
                  ...
                  onChange={(e) =>
                    updateValue('cli-defaults', 'server', parseInt(e.target.value))
                  }
                  className="setting-input"
                >
                  {[1, 2, 3, 4].map((n) => (
              ...
              <SettingField
                label="Part Size"
                description="Concurrent download parts"
              >
                <input
                  type="number"
                  min={1}
              ...
              <SettingField
                label="Dub Languages"
                description="Comma-separated codes, e.g. jpn,eng"
              >
                <input
                  type="text"
                  value={
              ...
              >
                <input
                  ...
                  onChange={(e) =>
                    updateValue('cli-defaults', 'defaultAudio', e.target.value)
                  }
                  placeholder="jpn"
                  className="setting-input"
                />
            ...
            <div className="space-y-4">
              ...
              >
                <input
                  ...
                  onChange={(e) =>
                    updateValue('dir-path', 'content', e.target.value)
                  }
              ...
              <SettingField
                ...
                description="Where subtitle fonts are stored"
              >
                <input
                  type="text"
                  value={(dir.fonts as string) || ''}
                  onChange={(e) =>
                    updateValue('dir-path', 'fonts', e.target.value)
                  }
          ...
          <div className="space-y-5">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted">
                  Configure bin-path.yml — paths to external tools
                </p>
              </div>
              <button
            ...
            <div className="space-y-4">
              {[
                ...
                <SettingField
                  key={b.key}
                  label={b.label}
                  description={`Path to ${b.label} executable`}
                >
                  <input
                    type="text"
                    value={(bin[b.key] as string) || ''}
                    onChange={(e) =>
                      updateValue('bin-path', b.key, e.target.value)
                    }
                    placeholder={b.ph}
                    className="setting-input font-mono"
                  />
