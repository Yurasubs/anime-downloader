...
import type { ServiceType, SearchResponseItem, Episode, QueueItem, ExtendedProgress } from "@/types"
...
export const useAppStore = create<AppState>(set => ({
    ...
    addNotification: (message, type) =>
        set(state => ({
            notifications: [...state.notifications, { id: String(++notifCounter), message, type }]
        })),
