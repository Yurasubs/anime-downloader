...
function SearchResultCard({
    ...
    return (
        ...
        >
            {item.image ? (
                <div className="relative w-14 aspect-[2/3] flex-shrink-0 rounded-lg overflow-hidden bg-background">
            ...
            <div className="flex-1 min-w-0">
                ...
                {item.desc && <p className="text-sm text-muted line-clamp-2 mt-1">{item.desc}</p>}
